...
aws emr-containers start-job-run \
  ...
  "sparkSubmitJobDriver": {
      "entryPoint": "s3://emr-on-eks-rss-'$ACCOUNTID'-us-west-2/mix-spark-boto3.py",
      "entryPointArguments":["s3://emr-on-eks-rss-'$ACCOUNTID'-us-west-2/BLOG_TPCDS-TEST-3T-partitioned/reason","https://sqs.us-west-2.amazonaws.com/'$ACCOUNTID'/karpenter-emr-eks-karpenter"],
    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          ...
          "spark.kubernetes.driver.podTemplateFile": "s3://'$S3BUCKET'/driver-pod-template.yaml",
          "spark.kubernetes.executor.podTemplateFile": "s3://'$S3BUCKET'/executor-pod-template.yaml"
      }}
    ], 
